...
def download(video_id, args):
    ...
    os.system('youtube-dl -f best/mp4 --write-auto-sub --write-sub --sub-lang en --skip-unavailable-fragments https://www.youtube.com/watch?v='+video_id+' --output '+video_path)
    return video_path
